...
int xdma_api_ioctl_bd_set_buffer_address(char *devname, int id, char *buffer) {
    ...
    printf("%s - id: %4d, buffer_address: %p, user_address: %16lx\n", 
	      __func__, bdSet.id, bdSet.buffer, bdSet.user_address);
...
int xdma_api_ioctl_bd_get_buffer_address(char *devname, int id, char *buffer) {
...
//    bdSet.user_address = (unsigned long)buffer;
    ...
    printf("%s - id: %4d, buffer_address: %p, user_address: %16lx\n", 
	      __func__, bdGet.id, bdGet.buffer, bdGet.user_address);
