...
int fpga_test_app(void)
{
    ...
    uint32_t reg_97th_hi, reg_97th_lo;
    uint32_t reg_98th_hi, reg_98th_lo;
    uint32_t reg_99th_hi, reg_99th_lo;
    uint32_t reg_100th_hi, reg_100th_lo;
    uint32_t reg_101th_hi, reg_101th_lo;
    uint32_t reg_102th_hi, reg_102th_lo;
    uint32_t reg_103th_hi, reg_103th_lo;
    uint32_t reg_104th_hi, reg_104th_lo;
    uint32_t read_reg_97th_hi, read_reg_97th_lo;
    uint32_t read_reg_98th_hi, read_reg_98th_lo;
    uint32_t read_reg_99th_hi, read_reg_99th_lo;
    uint32_t read_reg_100th_hi, read_reg_100th_lo;
    uint32_t read_reg_101th_hi, read_reg_101th_lo;
    uint32_t read_reg_102th_hi, read_reg_102th_lo;
    uint32_t read_reg_103th_hi, read_reg_103th_lo;
    uint32_t read_reg_104th_hi, read_reg_104th_lo;
    ...
    reg_104th_hi = 0;
    reg_97th_lo = 950926;
    reg_98th_lo = 22222222;
    reg_99th_lo = 33333333;
    reg_100th_lo = 44444444;
    reg_101th_lo = 55555555;
    reg_102th_lo = 66666666;
    reg_103th_lo = 77777777;
    reg_104th_lo = 88888888;

    while(1)
    {
        set_register(REG_PATH_TEST_REG_97TH_HIGH, reg_97th_hi);
        set_register(REG_PATH_TEST_REG_97TH_LOW, reg_97th_lo);
        set_register(REG_PATH_TEST_REG_98TH_HIGH, reg_98th_hi);
        set_register(REG_PATH_TEST_REG_98TH_LOW, reg_98th_lo);
        set_register(REG_PATH_TEST_REG_99TH_HIGH, reg_99th_hi);
        set_register(REG_PATH_TEST_REG_99TH_LOW, reg_99th_lo);
        set_register(REG_PATH_TEST_REG_100TH_HIGH, reg_100th_hi);
        set_register(REG_PATH_TEST_REG_100TH_LOW, reg_100th_lo);
        set_register(REG_PATH_TEST_REG_101TH_HIGH, reg_101th_hi);
        set_register(REG_PATH_TEST_REG_101TH_LOW, reg_101th_lo);
        set_register(REG_PATH_TEST_REG_102TH_HIGH, reg_102th_hi);
        set_register(REG_PATH_TEST_REG_102TH_LOW, reg_102th_lo);
        set_register(REG_PATH_TEST_REG_103TH_HIGH, reg_103th_hi);
        set_register(REG_PATH_TEST_REG_103TH_LOW, reg_103th_lo);
        set_register(REG_PATH_TEST_REG_104TH_HIGH, reg_104th_hi);
        set_register(REG_PATH_TEST_REG_104TH_LOW, reg_104th_lo);
        usleep(10*1000);

        read_reg_97th_hi = get_register(REG_PATH_TEST_REG_97TH_HIGH);
        read_reg_97th_lo = get_register(REG_PATH_TEST_REG_97TH_LOW);
        read_reg_98th_hi = get_register(REG_PATH_TEST_REG_98TH_HIGH);
        read_reg_98th_lo = get_register(REG_PATH_TEST_REG_98TH_LOW);
        read_reg_99th_hi = get_register(REG_PATH_TEST_REG_99TH_HIGH);
        read_reg_99th_lo = get_register(REG_PATH_TEST_REG_99TH_LOW);
        read_reg_100th_hi = get_register(REG_PATH_TEST_REG_100TH_HIGH);
        read_reg_100th_lo = get_register(REG_PATH_TEST_REG_100TH_LOW);
        read_reg_101th_hi = get_register(REG_PATH_TEST_REG_101TH_HIGH);
        read_reg_101th_lo = get_register(REG_PATH_TEST_REG_101TH_LOW);
        read_reg_102th_hi = get_register(REG_PATH_TEST_REG_102TH_HIGH);
        read_reg_102th_lo = get_register(REG_PATH_TEST_REG_102TH_LOW);
        read_reg_103th_hi = get_register(REG_PATH_TEST_REG_103TH_HIGH);
        read_reg_103th_lo = get_register(REG_PATH_TEST_REG_103TH_LOW);
        read_reg_104th_hi = get_register(REG_PATH_TEST_REG_104TH_HIGH);
        read_reg_104th_lo = get_register(REG_PATH_TEST_REG_104TH_LOW);
        usleep(10*1000);

        printf("============= Register Information =============\n");
        printf("read_reg_97th_hi  : %lu\n", read_reg_97th_hi);
        printf("read_reg_97th_lo  : %lu\n", read_reg_97th_lo);
        printf("read_reg_98th_hi  : %lu\n", read_reg_98th_hi);
        printf("read_reg_98th_lo  : %lu\n", read_reg_98th_lo);
        printf("read_reg_99th_hi  : %lu\n", read_reg_99th_hi);
        printf("read_reg_99th_lo  : %lu\n", read_reg_99th_lo);
        printf("read_reg_100th_hi  : %lu\n", read_reg_100th_hi);
        printf("read_reg_100th_lo  : %lu\n", read_reg_100th_lo);
        printf("read_reg_101th_hi  : %lu\n", read_reg_101th_hi);
        printf("read_reg_101th_lo  : %lu\n", read_reg_101th_lo);
        printf("read_reg_102th_hi  : %lu\n", read_reg_102th_hi);
        printf("read_reg_102th_lo  : %lu\n", read_reg_102th_lo);
        printf("read_reg_103th_hi  : %lu\n", read_reg_103th_hi);
        printf("read_reg_103th_lo  : %lu\n", read_reg_103th_lo);
        printf("read_reg_104th_hi  : %lu\n", read_reg_104th_hi);
        printf("read_reg_104th_lo  : %lu\n", read_reg_104th_lo);
        printf("\n\n");
        usleep(100*1000);
    }
    ...
    // uint32_t reg_9th_hi, reg_9th_lo;
    // uint32_t reg_10th_hi, reg_10th_lo;
    // uint32_t reg_11th_hi, reg_11th_lo;
    // uint32_t reg_12th_hi, reg_12th_lo;
    // uint32_t reg_13th_hi, reg_13th_lo;
    // uint32_t reg_14th_hi, reg_14th_lo;
    // uint32_t reg_15th_hi, reg_15th_lo;
    // uint32_t reg_16th_hi, reg_16th_lo;
    // uint32_t reg_17th_hi, reg_17th_lo;
    // uint32_t reg_18th_hi, reg_18th_lo;
    // uint32_t reg_19th_hi, reg_19th_lo;
    // uint32_t reg_20th_hi, reg_20th_lo;
    // uint32_t reg_21th_hi, reg_21th_lo;
    // uint32_t reg_22th_hi, reg_22th_lo;
    // uint32_t reg_23th_hi, reg_23th_lo;
    // uint32_t reg_24th_hi, reg_24th_lo;
    // uint32_t reg_25th_hi, reg_25th_lo;
    // uint32_t reg_26th_hi, reg_26th_lo;
    // uint32_t reg_27th_hi, reg_27th_lo;
    // uint32_t reg_28th_hi, reg_28th_lo;
    // uint32_t reg_29th_hi, reg_29th_lo;
    // uint32_t reg_30th_hi, reg_30th_lo;
    // uint32_t reg_31th_hi, reg_31th_lo;
    // uint32_t reg_32th_hi, reg_32th_lo;
    // uint32_t reg_33th_hi, reg_33th_lo;
    // uint32_t reg_34th_hi, reg_34th_lo;
    // uint32_t reg_35th_hi, reg_35th_lo;
    // uint32_t reg_36th_hi, reg_36th_lo;
    // uint32_t reg_37th_hi, reg_37th_lo;
    // uint32_t reg_38th_hi, reg_38th_lo;
    // uint32_t reg_39th_hi, reg_39th_lo;
    // uint32_t reg_40th_hi, reg_40th_lo;
    // uint32_t reg_41th_hi, reg_41th_lo;
    // uint32_t reg_42th_hi, reg_42th_lo;
    // uint32_t reg_43th_hi, reg_43th_lo;
    // uint32_t reg_44th_hi, reg_44th_lo;
    // uint32_t reg_45th_hi, reg_45th_lo;


    // while(1)
    // {
    //     reg_9th_hi = get_register(REG_PATH_TEST_REG_9TH_HIGH);
    //     reg_9th_lo = get_register(REG_PATH_TEST_REG_9TH_LOW);
    //     reg_10th_hi = get_register(REG_PATH_TEST_REG_10TH_HIGH);
    //     reg_10th_lo = get_register(REG_PATH_TEST_REG_10TH_LOW);
    //     reg_11th_hi = get_register(REG_PATH_TEST_REG_11TH_HIGH);
    //     reg_11th_lo = get_register(REG_PATH_TEST_REG_11TH_LOW);
    //     reg_12th_hi = get_register(REG_PATH_TEST_REG_12TH_HIGH);
    //     reg_12th_lo = get_register(REG_PATH_TEST_REG_12TH_LOW);
    //     reg_13th_hi = get_register(REG_PATH_TEST_REG_13TH_HIGH);
    //     reg_13th_lo = get_register(REG_PATH_TEST_REG_13TH_LOW);
    //     reg_14th_hi = get_register(REG_PATH_TEST_REG_14TH_HIGH);
    //     reg_14th_lo = get_register(REG_PATH_TEST_REG_14TH_LOW);
    //     reg_15th_hi = get_register(REG_PATH_TEST_REG_15TH_HIGH);
    //     reg_15th_lo = get_register(REG_PATH_TEST_REG_15TH_LOW);
    //     reg_16th_hi = get_register(REG_PATH_TEST_REG_16TH_HIGH);
    //     reg_16th_lo = get_register(REG_PATH_TEST_REG_16TH_LOW);
    //     reg_17th_hi = get_register(REG_PATH_TEST_REG_17TH_HIGH);
    //     reg_17th_lo = get_register(REG_PATH_TEST_REG_17TH_LOW);
    //     reg_18th_hi = get_register(REG_PATH_TEST_REG_18TH_HIGH);
    //     reg_18th_lo = get_register(REG_PATH_TEST_REG_18TH_LOW);
    //     reg_19th_hi = get_register(REG_PATH_TEST_REG_19TH_HIGH);
    //     reg_19th_lo = get_register(REG_PATH_TEST_REG_19TH_LOW);
    //     reg_20th_hi = get_register(REG_PATH_TEST_REG_20TH_HIGH);
    //     reg_20th_lo = get_register(REG_PATH_TEST_REG_20TH_LOW);
    //     reg_21th_hi = get_register(REG_PATH_TEST_REG_21TH_HIGH);
    //     reg_21th_lo = get_register(REG_PATH_TEST_REG_21TH_LOW);
    //     reg_22th_hi = get_register(REG_PATH_TEST_REG_22TH_HIGH);
    //     reg_22th_lo = get_register(REG_PATH_TEST_REG_22TH_LOW);
    //     reg_23th_hi = get_register(REG_PATH_TEST_REG_23TH_HIGH);
    //     reg_23th_lo = get_register(REG_PATH_TEST_REG_23TH_LOW);
    //     reg_24th_hi = get_register(REG_PATH_TEST_REG_24TH_HIGH);
    //     reg_24th_lo = get_register(REG_PATH_TEST_REG_24TH_LOW);
    //     reg_25th_hi = get_register(REG_PATH_TEST_REG_25TH_HIGH);
    //     reg_25th_lo = get_register(REG_PATH_TEST_REG_25TH_LOW);
    //     reg_26th_hi = get_register(REG_PATH_TEST_REG_26TH_HIGH);
    //     reg_26th_lo = get_register(REG_PATH_TEST_REG_26TH_LOW);
    //     reg_27th_hi = get_register(REG_PATH_TEST_REG_27TH_HIGH);
    //     reg_27th_lo = get_register(REG_PATH_TEST_REG_27TH_LOW);
    //     reg_28th_hi = get_register(REG_PATH_TEST_REG_28TH_HIGH);
    //     reg_28th_lo = get_register(REG_PATH_TEST_REG_28TH_LOW);
    //     reg_29th_hi = get_register(REG_PATH_TEST_REG_29TH_HIGH);
    //     reg_29th_lo = get_register(REG_PATH_TEST_REG_29TH_LOW);
    //     reg_30th_hi = get_register(REG_PATH_TEST_REG_30TH_HIGH);
    //     reg_30th_lo = get_register(REG_PATH_TEST_REG_30TH_LOW);
    //     reg_31th_hi = get_register(REG_PATH_TEST_REG_31TH_HIGH);
    //     reg_31th_lo = get_register(REG_PATH_TEST_REG_31TH_LOW);
    //     reg_32th_hi = get_register(REG_PATH_TEST_REG_32TH_HIGH);
    //     reg_32th_lo = get_register(REG_PATH_TEST_REG_32TH_LOW);
    //     reg_33th_hi = get_register(REG_PATH_TEST_REG_33TH_HIGH);
    //     reg_33th_lo = get_register(REG_PATH_TEST_REG_33TH_LOW);
    //     reg_34th_hi = get_register(REG_PATH_TEST_REG_34TH_HIGH);
    //     reg_34th_lo = get_register(REG_PATH_TEST_REG_34TH_LOW);
    //     reg_35th_hi = get_register(REG_PATH_TEST_REG_35TH_HIGH);
    //     reg_35th_lo = get_register(REG_PATH_TEST_REG_35TH_LOW);
    //     reg_36th_hi = get_register(REG_PATH_TEST_REG_36TH_HIGH);
    //     reg_36th_lo = get_register(REG_PATH_TEST_REG_36TH_LOW);
    //     reg_37th_hi = get_register(REG_PATH_TEST_REG_37TH_HIGH);
    //     reg_37th_lo = get_register(REG_PATH_TEST_REG_37TH_LOW);
    //     reg_38th_hi = get_register(REG_PATH_TEST_REG_38TH_HIGH);
    //     reg_38th_lo = get_register(REG_PATH_TEST_REG_38TH_LOW);
    //     reg_39th_hi = get_register(REG_PATH_TEST_REG_39TH_HIGH);
    //     reg_39th_lo = get_register(REG_PATH_TEST_REG_39TH_LOW);
    //     reg_40th_hi = get_register(REG_PATH_TEST_REG_40TH_HIGH);
    //     reg_40th_lo = get_register(REG_PATH_TEST_REG_40TH_LOW);
    //     reg_41th_hi = get_register(REG_PATH_TEST_REG_41TH_HIGH);
    //     reg_41th_lo = get_register(REG_PATH_TEST_REG_41TH_LOW);
    //     reg_42th_hi = get_register(REG_PATH_TEST_REG_42TH_HIGH);
    //     reg_42th_lo = get_register(REG_PATH_TEST_REG_42TH_LOW);
    //     reg_43th_hi = get_register(REG_PATH_TEST_REG_43TH_HIGH);
    //     reg_43th_lo = get_register(REG_PATH_TEST_REG_43TH_LOW);
    //     reg_44th_hi = get_register(REG_PATH_TEST_REG_44TH_HIGH);
    //     reg_44th_lo = get_register(REG_PATH_TEST_REG_44TH_LOW);
    //     reg_45th_hi = get_register(REG_PATH_TEST_REG_45TH_HIGH);
    //     reg_45th_lo = get_register(REG_PATH_TEST_REG_45TH_LOW);


    //     printf("============= Register Information =============\n");
    //     printf("// Upper 32bit Registers\n");

    //     printf("syscount_hi       : %lu\n", reg_9th_hi);
    //     printf("tx_tstamp1_hi     : %lu\n", reg_10th_hi);
    //     printf("tx_tstamp2_hi     : %lu\n", reg_11th_hi);
    //     printf("tx_tstamp3_hi     : %lu\n", reg_12th_hi);
    //     printf("tx_tstamp4_hi     : %lu\n\n", reg_13th_hi);
    //     printf("tx_stat_reg1_hi   : %lu\n", reg_14th_hi);
    //     printf("tx_stat_reg2_hi   : %lu\n", reg_15th_hi);
    //     printf("tx_stat_reg3_hi   : %lu\n", reg_16th_hi);
    //     printf("tx_stat_reg4_hi   : %lu\n", reg_17th_hi);
    //     printf("tx_stat_reg5_hi   : %lu\n", reg_18th_hi);
    //     printf("tx_stat_reg6_hi   : %lu\n", reg_19th_hi);
    //     printf("tx_stat_reg7_hi   : %lu\n", reg_20th_hi);
    //     printf("tx_stat_reg8_hi   : %lu\n", reg_21th_hi);
    //     printf("tx_stat_reg9_hi   : %lu\n", reg_22th_hi);
    //     printf("tx_stat_reg10_hi  : %lu\n", reg_23th_hi);
    //     printf("tx_stat_reg11_hi  : %lu\n", reg_24th_hi);
    //     printf("tx_stat_reg12_hi  : %lu\n", reg_25th_hi);
    //     printf("tx_stat_reg13_hi  : %lu\n", reg_26th_hi);
    //     printf("tx_stat_reg14_hi  : %lu\n", reg_27th_hi);
    //     printf("tx_stat_reg15_hi  : %lu\n", reg_28th_hi);
    //     printf("tx_stat_reg16_hi  : %lu\n", reg_29th_hi);
    //     printf("tx_stat_reg17_hi  : %lu\n", reg_30th_hi);
    //     printf("tx_stat_reg18_hi  : %lu\n", reg_31th_hi);
    //     printf("tx_stat_reg19_hi  : %lu\n", reg_32th_hi);
    //     printf("tx_stat_reg20_hi  : %lu\n", reg_33th_hi);
    //     printf("tx_stat_reg21_hi  : %lu\n", reg_34th_hi);
    //     printf("tx_stat_reg22_hi  : %lu\n", reg_35th_hi);
    //     printf("tx_stat_reg23_hi  : %lu\n", reg_36th_hi);
    //     printf("tx_stat_reg24_hi  : %lu\n", reg_37th_hi);
    //     printf("tx_stat_reg25_hi  : %lu\n", reg_38th_hi);
    //     printf("tx_stat_reg26_hi  : %lu\n", reg_39th_hi);
    //     printf("tx_stat_reg27_hi  : %lu\n", reg_40th_hi);
    //     printf("tx_stat_reg28_hi  : %lu\n", reg_41th_hi);
    //     printf("tx_stat_reg29_hi  : %lu\n", reg_42th_hi);
    //     printf("tx_stat_reg30_hi  : %lu\n", reg_43th_hi);
    //     printf("tx_stat_reg31_hi  : %lu\n", reg_44th_hi);
    //     printf("tx_stat_reg32_hi  : %lu\n", reg_45th_hi);
        
    //     printf("\n\n");

    //     printf("// Lower 32bit Registers\n");

    //     printf("syscount_lo       : %lu\n", reg_9th_lo);
    //     printf("tx_tstamp1_lo     : %lu\n", reg_10th_lo);
    //     printf("tx_tstamp2_lo     : %lu\n", reg_11th_lo);
    //     printf("tx_tstamp3_lo     : %lu\n", reg_12th_lo);
    //     printf("tx_tstamp4_lo     : %lu\n", reg_13th_lo);
    //     printf("tx_stat_reg1_lo   : %lu\n", reg_14th_lo);
    //     printf("tx_stat_reg2_lo   : %lu\n", reg_15th_lo);
    //     printf("tx_stat_reg3_lo   : %lu\n", reg_16th_lo);
    //     printf("tx_stat_reg4_lo   : %lu\n", reg_17th_lo);
    //     printf("tx_stat_reg5_lo   : %lu\n", reg_18th_lo);
    //     printf("tx_stat_reg6_lo   : %lu\n", reg_19th_lo);
    //     printf("tx_stat_reg7_lo   : %lu\n", reg_20th_lo);
    //     printf("tx_stat_reg8_lo   : %lu\n", reg_21th_lo);
    //     printf("tx_stat_reg9_lo   : %lu\n", reg_22th_lo);
    //     printf("tx_stat_reg10_lo  : %lu\n", reg_23th_lo);
    //     printf("tx_stat_reg11_lo  : %lu\n", reg_24th_lo);
    //     printf("tx_stat_reg12_lo  : %lu\n", reg_25th_lo);
    //     printf("tx_stat_reg13_lo  : %lu\n", reg_26th_lo);
    //     printf("tx_stat_reg14_lo  : %lu\n", reg_27th_lo);
    //     printf("tx_stat_reg15_lo  : %lu\n", reg_28th_lo);
    //     printf("tx_stat_reg16_lo  : %lu\n", reg_29th_lo);
    //     printf("tx_stat_reg17_lo  : %lu\n", reg_30th_lo);
    //     printf("tx_stat_reg18_lo  : %lu\n", reg_31th_lo);
    //     printf("tx_stat_reg19_lo  : %lu\n", reg_32th_lo);
    //     printf("tx_stat_reg20_lo  : %lu\n", reg_33th_lo);
    //     printf("tx_stat_reg21_lo  : %lu\n", reg_34th_lo);
    //     printf("tx_stat_reg22_lo  : %lu\n", reg_35th_lo);
    //     printf("tx_stat_reg23_lo  : %lu\n", reg_36th_lo);
    //     printf("tx_stat_reg24_lo  : %lu\n", reg_37th_lo);
    //     printf("tx_stat_reg25_lo  : %lu\n", reg_38th_lo);
    //     printf("tx_stat_reg26_lo  : %lu\n", reg_39th_lo);
    //     printf("tx_stat_reg27_lo  : %lu\n", reg_40th_lo);
    //     printf("tx_stat_reg28_lo  : %lu\n", reg_41th_lo);
    //     printf("tx_stat_reg29_lo  : %lu\n", reg_42th_lo);
    //     printf("tx_stat_reg30_lo  : %lu\n", reg_43th_lo);
    //     printf("tx_stat_reg31_lo  : %lu\n", reg_44th_lo);
    //     printf("tx_stat_reg32_lo  : %lu\n", reg_45th_lo);
    //     printf("\n\n");
...
int tx_tstamp_replica_fpga_logic_test_app(void)
{
    ...
    while(1)
    {
        ...
        // 3-2. Set Tx Timestamp Request bit
        set_register(REG_CONTROL, 1);

        // 3-3. Increase Statistics (Tx packets, Bytes)
        my_tx_stats.txPackets++;

        // 3-4. Get System Count & Tx Timestamp
        my_syscount     = ((uint64_t)get_register(REG_REG0_UPPER) << 32) | get_register(REG_REG0_LOWER);
        my_tx_timestamp = ((uint64_t)get_register(REG_REG1_UPPER) << 32) | get_register(REG_REG1_LOWER);
        ...
        // 3-12. Clear Tx Timestamp Request bit
        set_register(REG_CONTROL, 0);
